...
-- 1
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Pera', 'Perić', 'MALE', 'Bulevar cara Lazara 88', 1, 45.24136867255004, 19.829921403835918, '4444444444', 'hesoyampharmacy+admin@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('14-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Nikola', 'Dragić', 'MALE', 'Bulevar oslobođenja 147', 1, 45.24046220156171, 19.843969833190673, '4444444444', 'hesoyampharmacy+dragic@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('15-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Luka', 'Kričković', 'MALE', 'Narodnog fronta 187', 1, 45.2373330656835, 19.82722036933235, '4444444444', 'hesoyampharmacy+kricko@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Aleksa', 'Vučaj', 'MALE', 'Fruškogorska 24', 1, 45.24092378110751, 19.84746195352302, '4444444444', 'hesoyampharmacy+vucaj@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Gergelj', 'Kiš', 'MALE', 'Bulevar Evrope 42', 1, 45.24366408340239, 19.82013338399792, '4444444444', 'hesoyampharmacy+kis@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Mila', 'Milanović', 'FEMALE', 'Šabačka 41', 3, 44.80115575659176, 20.49294129684957, '4444444444', 'hesoyampharmacy+mila@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Jovan', 'Jovanović', 'MALE', 'Karađorđeva 32', 2, 44.02636626175418, 20.45674605711011, '4444444444', 'hesoyampharmacy+jovan@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
INSERT INTO employee
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Milan', 'Milanović', 'MALE', 'Savski trg 11', 3, 44.80878328562551, 20.45740555451793, '4444444444', 'hesoyampharmacy+milan@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
INSERT INTO employee
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Jadranka', 'Jadranovič', 'FEMALE', 'Subotička 21', 1, 45.24542077279943, 19.813604101767236, '4444444444', 'hesoyampharmacy+jadranka@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
INSERT INTO employee
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Ivana', 'Ivanović', 'FEMALE', 'Ćirpanova 4', 1, 45.25299175875651, 19.835303400426874, '4444444444', 'hesoyampharmacy+ivana@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
INSERT INTO employee
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Mika', 'Mikić', 'DONT_SAY', 'Tolstojeva 12', 1, 45.24535673373681, 19.833914938362007, '4444444444', 'hesoyampharmacy+mika@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
INSERT INTO employee
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Dragan', 'Dragić', 'MALE', 'Dositejeva 17', 1, 45.26315474237813, 19.84141604011822, '4444444444', 'hesoyampharmacy+dragan@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
INSERT INTO employee
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Marko', 'Marković', 'MALE', 'Masarikova 18', 1, 45.25780011333192, 19.83853464148449, '4444444444', 'hesoyampharmacy+marko@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('24-01-2021', 'DD-MM-YYYY'), true);
INSERT INTO employee
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Veselin', 'Tomić', 'MALE', 'Rumenačka 147', 1, 45.265666787857164, 19.81474531978888, '4444444444', 'hesoyampharmacy+veselin@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('04-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Svetlana', 'Branković', 'FEMALE', 'Futoški put 76', 1, 45.247088659951785, 19.803792899301826, '4444444444', 'hesoyampharmacy+ceca@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('04-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Lidija', 'Kovač', 'FEMALE', 'Futoška 46', 1, 45.24900654614174, 19.826952620050363, '4444444444', 'hesoyampharmacy+lidija@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('04-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Radovan', 'Petrović', 'MALE', 'Novosadskog sajma 41', 1, 45.253902952298034, 19.825503048784817, '4444444444', 'hesoyampharmacy+radovan@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('04-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Sandra', 'Filipović', 'FEMALE', 'Sarajevska 83', 3, 44.800638193104234, 20.451638118625414, '4444444444', 'hesoyampharmacy+sandra@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('04-01-2021', 'DD-MM-YYYY'), true);
...
INSERT INTO users
    (first_name, last_name, gender, address_line, city_id, latitude, longitude, telephone, email, password, last_password_reset_date, enabled) 
    VALUES
    ('Marina', 'Marić', 'FEMALE', 'Novosadska 37', 3, 44.914103309371924, 20.267538944371907, '4444444444', 'hesoyampharmacy+marina@gmail.com', '$2a$10$Cz0brjWGJa525Fd/ub3nW.U1aLsYRYp7mslmoh2B7Gcm/VQb4CTOS', to_timestamp('04-01-2021', 'DD-MM-YYYY'), true);
